...
Simple acceptance testing, the skips all the tests after a failing test. This is built on RSpec2 and leverages RSpec2's metadata.
...
Copyright (c) 2010 Pedro Belo, Terence Lee
